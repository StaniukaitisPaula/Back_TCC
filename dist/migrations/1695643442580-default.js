...
exports.default1695643442580 = void 0;
class default1695643442580 {
    constructor() {
        this.name = 'default1695643442580';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`tbl_organizador\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nome_organizacao\` varchar(100) NOT NULL, \`foto_organizacao\` text NOT NULL, \`biografia\` text NOT NULL, \`perfilId\` int NULL, UNIQUE INDEX \`REL_109c3fa2a73276aef279dd4a96\` (\`perfilId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
...
exports.default1695643442580 = default1695643442580;
