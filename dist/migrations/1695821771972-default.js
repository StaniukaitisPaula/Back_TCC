...
exports.Default1695821771972 = void 0;
class Default1695821771972 {
    constructor() {
        this.name = 'Default1695821771972';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`tbl_perfil\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nome_usuario\` varchar(100) NOT NULL, \`nome_completo\` varchar(100) NOT NULL, \`email\` varchar(255) NOT NULL, \`senha\` text NOT NULL, \`data_nascimento\` date NOT NULL, \`genero\` int NOT NULL, UNIQUE INDEX \`IDX_bb0384a7728c6ba7f54fffbdde\` (\`nome_usuario\`), UNIQUE INDEX \`IDX_f7e13d8188cfefb0d2017393f6\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`tbl_organizador\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nome_organizacao\` varchar(100) NOT NULL, \`biografia\` text NOT NULL, \`perfilId\` int NULL, UNIQUE INDEX \`REL_109c3fa2a73276aef279dd4a96\` (\`perfilId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
...
exports.Default1695821771972 = Default1695821771972;
